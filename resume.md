...
### 物流库存相关业务系统
#### 项目描述: 
三方物流系统,库存管理(报关,运输)系统.

#### 难点/贡献: 
担任技术选型,基础组件开发,服务架构设计,库表设计等工作.
引入jpa-spec或mybatis-plus组件,提高业务开发效率
基础util,starter,中间件应用 开发及优化,如操作日志系统等
一些运维工作,优化了前后端的发布流程,大幅提高了发布和访问效率(前端从k8s,nginx部署,改为oss静态部署. 前端发布增加了node_modules缓存,自动判断package.json版本)
